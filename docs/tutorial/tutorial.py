...
# %% 
library = pai.Library(source='demo/demo_data/ogTarget_dataset.csv', seqs_col='binder_seq', y_col='pae_interaction_HLA-A101-RVTDESILSY', 
...
# %% 
out = model.search(optim_problem='max', overwrite=True)
